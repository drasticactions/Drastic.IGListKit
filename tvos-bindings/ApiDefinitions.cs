...
namespace IGListKit
{
	...
	interface IGListAdapterPerformanceDelegate
	{
		...
		void ListAdapter (IGListAdapter listAdapter, UICollectionViewCell cell, IGListSectionController sectionController, nint index);
		...
		void ListAdapter (IGListAdapter listAdapter, IGListSectionController sectionController, nint index);
...
*/[Protocol]
	...
	interface IGListAdapter
	{
		...
		// @property (nonatomic, weak) NS_AVAILABLE_IOS(9_0) id<IGListAdapterMoveDelegate> moveDelegate __attribute__((availability(ios, introduced=9.0))) __attribute__((availability(tvos, introduced=9.0)));
		[TV (9, 0), iOS (9, 0)]
	...
	[BaseType (typeof(NSObject))]
	interface IGListAdapterUpdater : IIGListUpdatingDelegate
	{
		[Wrap ("WeakDelegate")]
		[NullAllowed]
...
*/[Protocol]
	...
	interface IGListBatchContext
	{
		...
		// @required -(void)moveSectionControllerInteractive:(IGListSectionController * _Nonnull)sectionController fromIndex:(NSInteger)fromIndex toIndex:(NSInteger)toIndex __attribute__((availability(ios, introduced=9.0))) __attribute__((availability(tvos, introduced=9.0)));
		[TV (9,0), iOS (9,0)]
		[Abstract]
		...
		// @required -(void)moveInSectionControllerInteractive:(IGListSectionController * _Nonnull)sectionController fromIndex:(NSInteger)fromIndex toIndex:(NSInteger)toIndex __attribute__((availability(ios, introduced=9.0))) __attribute__((availability(tvos, introduced=9.0)));
		[TV (9,0), iOS (9,0)]
		[Abstract]
		...
		// @required -(void)revertInvalidInteractiveMoveFromIndexPath:(NSIndexPath * _Nonnull)sourceIndexPath toIndexPath:(NSIndexPath * _Nonnull)destinationIndexPath __attribute__((availability(ios, introduced=9.0))) __attribute__((availability(tvos, introduced=9.0)));
		[TV (9,0), iOS (9,0)]
		[Abstract]
...
*/[Protocol]
	...
	interface IGListSectionController
	{
		...
		// -(void)moveObjectFromIndex:(NSInteger)sourceIndex toIndex:(NSInteger)destinationIndex __attribute__((availability(ios, introduced=9.0))) __attribute__((availability(tvos, introduced=9.0)));
		[TV (9,0), iOS (9,0)]
...
*/[Protocol]
	interface IGListCollectionViewDelegateLayout : IUICollectionViewDelegateFlowLayout
	{
		...
		UICollectionViewLayoutAttributes Layout (UICollectionView collectionView, UICollectionViewLayout collectionViewLayout, UICollectionViewLayoutAttributes attributes, NSIndexPath indexPath);
...
*/[Protocol]
	...
	[DisableDefaultCtor]
	interface IGListCollectionViewLayout : IIGListCollectionViewLayoutCompatible
	{
	...
	[BaseType (typeof(NSObject))]
	interface IGListReloadDataUpdater : IIGListUpdatingDelegate
	{
	}
